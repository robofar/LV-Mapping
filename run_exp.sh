...
# python pings.py ./config/lidar_slam/run_ipbcar_gs.yaml ipb_car -i ./data/ipb_car/2024-04-30_cheap_car/extracted/ -sgm --range 1850 2000 1 --tag roundabout_${exp_tag}
...
# python pings.py ./config/lidar_slam/run_ipbcar_gs.yaml ipb_car -i ./data/ipb_car/2024-04-30_cheap_car/extracted/ -sgm --range 550 700 1 --tag neighbor_${exp_tag}
...
python pings.py ./config/lidar_slam/run_ipbcar_gs_full_res.yaml ipb_car -i ./data/ipb_car/2024-04-30_cheap_car/extracted/ -sgm --range 100 250 1 --tag math_${exp_tag}
# python pings.py ./config/lidar_slam/run_ipbcar_gs.yaml ipb_car -i ./data/ipb_car/2024-04-30_cheap_car/extracted/ -sgm --range 100 250 1 --tag math_${exp_tag}
...
python pings.py ./config/lidar_slam/run_ipbcar_gs_full_res.yaml ipb_car -i ./data/ipb_car/2024-04-30_cheap_car/extracted/ -sgm --range 2650 2800 1 --tag seba_${exp_tag}
# python pings.py ./config/lidar_slam/run_ipbcar_gs.yaml ipb_car -i ./data/ipb_car/2024-04-30_cheap_car/extracted/ -sgm --range 2650 2800 1 --tag seba_${exp_tag}
