...
python inspect_pings.py  ./pings_experiments/seba_${exp_tag}_test_ipbcar_gs_ours*/ -i ./data/ipb_car/2024-04-30_cheap_car/extracted_2/  --range 2180 2240 1 -e --vis_off
python inspect_pings.py  ./pings_experiments/seba_${exp_tag}_test_ipbcar_gs_without*/ -i ./data/ipb_car/2024-04-30_cheap_car/extracted_2/  --range 2180 2240 1 -e --vis_off