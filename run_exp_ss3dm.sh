...
# echo "Run on SS3DM dataset..."

python pings.py ./config/lidar_slam/run_ss3dm_gs.yaml ss3dm -i ./data/SS3DM-Dataset/SS3DM_data/Town10/1000_streetsurf/ -sg --tag sanity_${exp_tag} --range 100 120 1

python pings.py ./config/lidar_slam/run_ss3dm_gs.yaml ss3dm -i ./data/SS3DM-Dataset/SS3DM_data/Town10/200_streetsurf/ -sg --tag 200_${exp_tag}

python pings.py ./config/lidar_slam/run_ss3dm_gs.yaml ss3dm -i ./data/SS3DM-Dataset/SS3DM_data/Town10/300_streetsurf/ -sg --tag 300_${exp_tag}

python pings.py ./config/lidar_slam/run_ss3dm_gs.yaml ss3dm -i ./data/SS3DM-Dataset/SS3DM_data/Town10/580_streetsurf/ -sg --tag 580_${exp_tag}

python pings.py ./config/lidar_slam/run_ss3dm_gs.yaml ss3dm -i ./data/SS3DM-Dataset/SS3DM_data/Town10/1000_streetsurf/ -sg --tag 1000_${exp_tag}
